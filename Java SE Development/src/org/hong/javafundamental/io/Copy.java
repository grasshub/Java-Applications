...
public class Copy {
    ...
    private static boolean okToOverwrite(Path file) {
        ...
        try {
            ...
            System.out.println("Unable to get user confirmation" + file);
    ...
    public static void main(String[] args) throws IOException {
		...
		copySourceToTarget(recursive, prompt, preserve, sources, target, isDir);
	...
	private static void copySourceToTarget(boolean recursive, boolean prompt, boolean preserve, Path[] sources, Path target, boolean isDir) throws IOException {
